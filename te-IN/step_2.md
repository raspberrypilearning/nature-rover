...
మీరు ఆఫ్‌లైన్‌లో పని చేస్తుంటే, స్టార్టర్ ప్రాజెక్ట్‌ను [rpf.io/p/te-IN/nature-rover-go](https://rpf.io/p/te-IN/nature-rover-go)లో కనుగొనవచ్చు
...
when I receive [up v]
change y by (10)
change size by (-1) //చిన్నది మరింత దూరంగా కనిపిస్తుంది


when I receive [down v]
change y by (-10)
change size by (1) //పెద్దది దగ్గరగా కనిపిస్తుంది
```
