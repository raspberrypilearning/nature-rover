...
Abra o projeto inicial on-line em [rpf.io/nature-rover-starter](https://scratch.mit.edu/projects/1237781918/){:target="_blank"}.
...
Se você estiver trabalhando offline, o projeto inicial pode ser encontrado em [rpf.io/p/pt-BR/nature-rover-go](https://rpf.io/p/pt-BR/nature-rover-go)
...
when [seta para baixo v] key pressed
broadcast [para baixo v]

when [seta para direita v] key pressed
broadcast [direita v]

when [seta para esquerda v] key pressed
broadcast [esquerda v]
```
...
when I receive [para cima v]
change y by (10)
change size by (-1) // O menor parece mais distante


when I receive [para baixo v]
change y by (-10)
change size by (1) // O maior parece mais próximo
```
